...
# put the code under class
# add the function that get the views for booker
...
if __name__=='__main__':
	proxies_list = []
	proxies = proxies()
	if os.path.exists('proxy/proxies.txt'):
		...
		filename = open('proxy/proxies.txt', 'w')
		for x in range(10):
	...
	print("博客访问量：",format(int(csdn.check_booker_num()[0])))
